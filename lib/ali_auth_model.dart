...
AliAuthModel getDialogConfig() {
  final screenWidth =
      (window.physicalSize.width / window.devicePixelRatio * 1).floor();
  final screenHeight =
      (window.physicalSize.height / window.devicePixelRatio * 0.5).floor();
  ...
  return AliAuthModel.fromJson({
    ...
    'loadingImgPath': '',
    'appPrivacyOne':
        '《用户协议》,http://zhangmen.dinggou.zjcem.com/zm/register-protocol.html',
    'appPrivacyTwo': '《隐私政策》,http://zhangmen.dinggou.zjcem.com/zm/privacy.html',
    ...
    'privacyMargin': 20,
    'checkBoxWH': 20,
    'uncheckedImgPath': 'assets/images/uncheckedImgPath.png',
    'checkedImgPath': 'assets/images/checkedImgPath.png',
    'changeBtnTitle': '验证码登录 | 注册',
    'changeBtnTitleSize': 14,
    'changeBtnTitleColor': '#FF191C27',
